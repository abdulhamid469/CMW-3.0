...
let listFruits: string[] = ["Apple", "Banana", "Mango"];
 ...
 */
    ...
    // Splice
    const animals: string[] = ["Cat", "Loins", "House", "Dog"];
    animals.splice(1, 0, "Rabbit");
    console.log(animals);

    // Slice
    const countries:string[] = ["Pakistan", "Afghanistan", "Iran", "Turky"];
    const ourSideCountry: string[] = countries.slice(3, 4);
